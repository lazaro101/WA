...
<div id="navbar-full">
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active"><a href="product.php">
    ...
    <div class='blurred-container'>
        ...
        <div class="img-src" style="background-image: url('assets/img/products.jpg')"></div>
    </div> <!-- end carousel -->
</div>     
...
<center>
<div class="container">
    <h1 style="color: red; text-shadow: 2px 2px yellow"><strong>BITZ INSURANCE</strong></h1>
    <img src="assets/img/age.png" style="height: 80PX"><br><br><br><br><br>
    <h2 style="text-shadow: 2px 2px yellow"><strong><b>Plan Type</b></strong></h2><br>
    <div class="col-md-12">
        <div class="content">
              <div>
                <img src="assets/img/plantype2.png">
              </div>
            </div>
        </div>
    </div>
...
<div class="container">
        <h2 style="text-shadow: 2px 2px yellow"><strong><b>Product Variant</b></strong></h2><br>
        
         <div class="col-md-4">
        <div class="content">
              <div>
                <img src="assets/img/basic2.png">
              </div>
            </div>
        </div>
        ...
        <div class="content">
              <div>
                <img src="assets/img/basicplus2.png">
              </div>
            </div>
        </div>
        ...
        <div class="content">
              <div>
                <img src="assets/img/smartplus2.png">
              </div>
            </div>
        </div>
    ...
    <div class="container">
        <h2 style="text-shadow: 2px 2px yellow"><strong><b>For Occupational Classes 1, 2 and 3 Only</b></strong><br>(7 Yrs. Old - 70 Yrs. Old)</h2><br>
    <div class="col-md-6">
        <div class="content">
              <div>
                <img src="assets/img/shieldplus2.png">
              </div>
            </div>
        </div>
        ...
        <div class="content">
              <div>
                <img src="assets/img/shieldmax2.png">
              </div>
            </div>
        </div>
    </div>
